<%-- 
    Document   : delete_bill
    Created on : May 19, 2017, 9:12:18 PM
    Author     : Admin
--%>
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="alert alert-danger fade in">
                                <span><i class="fa fa-bullhorn"></i> Bạn có chắc chắn muốn hủy hóa đơn này?</span>
                            </div>
                    ...
                    <div class="box-footer">
                        ...
                        <a href='/shop/ManagerBillServlet?command=delete_bill&billID=<%=billID%>' class="btn btn-danger pull-right">Hủy</a>   
                    </div>
                </div>
