<%-- 
    Document   : paid_bill
    Created on : May 19, 2017, 8:59:59 PM
    Author     : Admin
--%>
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="alert alert-warning fade in">
                                <span><i class="fa fa-bullhorn"></i> Bạn có chắc chắn muốn thanh toán cho hóa đơn này?</span>
                    ...
                    <div class="box-footer">
                        ...
                        <a href='/shop/ManagerBillServlet?command=paid_bill&billID=<%=billID%>' class="btn btn-primary pull-right">Thanh toán</a>   
                    </div>
                </div>
