<%-- 
    Document   : approve_bill
    Created on : May 19, 2017, 9:09:08 PM
    Author     : Admin
--%>
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="alert alert-warning fade in">
                                <span><i class="fa fa-bullhorn"></i> Bạn có chắc chắn muốn duyệt hóa đơn này?</span>
                            </div>
                    ...
                    <div class="box-footer">
                        ...
                        <a href='/shop/ManagerBillServlet?command=approve_bill&billID=<%=billID%>' class="btn btn-primary pull-right">Duyệt</a>   
                    </div>
                </div>
                <!-- /.box -->
            </section>
